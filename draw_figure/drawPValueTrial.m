function lgd = drawPValueTrial(z_score,edges,lgd,decoder,options,color,subplotIdx)
subplot(subplotIdx);
decoder = strrep(decoder,'_','\_');
lgd0 = plot(edges,z_score.pValue ,[color '-'],'linewidth',2,'DisplayName',['AR(1)-' options '-' decoder ' p-value']);
set(gca,'YLim',[1e-4 1]);
set(gca,'YScale','log');
lgd = [lgd lgd0];
